	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<div
			...
			<ul class="navbar-nav ml-auto d-flex align-items-center">
				<!-- Link to Products -->
				<li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/videos">Sản
						phẩm</a></li>
				<!-- Chỉ hiển thị "Trang quản trị" nếu người dùng có vai trò admin -->
				<c:if test="${sessionScope.account.getAdmin()}">
					<li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/admin/category">Trang
							quản trị</a></li>
				</c:if>
